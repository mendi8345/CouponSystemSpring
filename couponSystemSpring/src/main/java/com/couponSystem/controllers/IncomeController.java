...
// ResponseEntity<List<Income>> result = new
// ResponseEntity<List<Income>>(this.incomeService.viewAllIncome(),
// HttpStatus.OK);
// return result;
// }
//
...
// ResponseEntity<Income> result = new
// ResponseEntity<Income>(this.incomeService.getIncome(id), HttpStatus.OK);
// return result;
// }
//
// }
